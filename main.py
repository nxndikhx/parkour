...
def main():
    ...
    while True:
        ...
        vehicle_number = scanned_plate[0].upper() if scanned_plate else input("Enter vehicle number: ").upper()
        ...
        while True:
            ...
            if action == "1":
                ...
                scanned_plate = capture_plate()
                if scanned_plate:
                    vehicle_number = scanned_plate[0].upper()
